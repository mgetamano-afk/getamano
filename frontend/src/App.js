...
function AppRouter() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/referrals" element={<DashboardRouter />} />
      <Route path="/referidos" element={<DashboardRouter />} />
      <Route path="/wallet" element={<DashboardRouter />} />
      <Route path="/cartera" element={<DashboardRouter />} />
