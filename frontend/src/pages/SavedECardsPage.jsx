      ...
      <main className="container mx-auto px-4 md:px-6 py-8 pb-24 max-w-5xl">
        ...
        {!loading && items.length === 0 && (
          <EmptyState
            ...
            subtitle={t("saved.empty.body")}
            primaryAction={{
              label: t("saved.empty.cta"),
              onClick: () => navigate(lang === "en" ? "/search" : "/buscar"),
            }}
            tip={lang === "en" ? "Tap the bookmark on any eCard to save it" : "Toca el marcador en cualquier eCard para guardarla"}
          />
        )}
