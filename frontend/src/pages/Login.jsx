      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
          ...
          <div className="space-y-2">
            <button type="button" onClick={googleLogin} className="w-full h-12 rounded-full border-2 border-slate-200 hover:border-slate-300 flex items-center justify-center gap-2 font-medium text-slate-700" data-testid="login-google-button">
            ...
            <button type="button" disabled title="Próximamente" className="w-full h-12 rounded-full border-2 border-slate-200 flex items-center justify-center gap-2 font-medium text-slate-400 cursor-not-allowed bg-slate-50/50" data-testid="login-apple-button">
            ...
            <button type="button" disabled title="Próximamente" className="w-full h-12 rounded-full border-2 border-slate-200 flex items-center justify-center gap-2 font-medium text-slate-400 cursor-not-allowed bg-slate-50/50" data-testid="login-facebook-button">
