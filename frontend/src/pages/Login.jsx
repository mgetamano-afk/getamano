      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
          ...
          <div className="space-y-2">
            ...
            <AppleSignInButton onAfterLogin={(u) => navigate(u.role === "admin" ? "/dashboard/admin" : u.role === "provider" ? "/dashboard/provider" : "/dashboard/client")} />
            <FacebookSignInButton onAfterLogin={(u) => navigate(u.role === "admin" ? "/dashboard/admin" : u.role === "provider" ? "/dashboard/provider" : "/dashboard/client")} />
          </div>
