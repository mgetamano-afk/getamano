...
export default function SeoCategoryDetail() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F7F6F2" }}>
      <SeoHead
        title={`${category.name_es} en USA — Proveedores latinos verificados`}
        description={`Encuentra proveedores latinos verificados de ${category.name_es.toLowerCase()} en ${total_cities} ciudades de USA. ${totalProviders} negocios activos en getamano.`}
        canonical={`${origin}/servicios/${category.slug}`}
