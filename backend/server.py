...
# V19.3 — /admin/categories, /admin/cities, /cities, /admin/audit-log moved to routes/admin_catalog.py
...
# V19.3 — Admin insights (ceo-metrics, code-health, daily-brief) moved
# out of server.py into routes/admin_insights.py. Extraction validated
# by /admin/code-health itself (server.py LOC dropped ~510 → matches
# the founder's "your dashboard is screaming this" verdict).
api_router.include_router(
    _make_admin_insights_router(
        db=db,
        User=User,
        require_admin=require_admin,
...
# V19.3 — Admin catalog (categories, cities, audit-log + public /cities)
# moved to routes/admin_catalog.py. Self-contained CRUD wrappers.
api_router.include_router(
    _make_admin_catalog_router(
        db=db,
        User=User,
        require_admin=require_admin,
